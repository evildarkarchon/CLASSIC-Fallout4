...
class scanlog:
    ...
    class SettingsValidator:
        ...
        def check_memory_settings(self, crashgen_settings: dict[str, Any]) -> str | None: ...
        def check_achievements(self, crashgen_settings: dict[str, Any], xse_modules: set[str]) -> str | None: ...
