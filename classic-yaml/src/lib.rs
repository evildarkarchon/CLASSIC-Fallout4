//! CLASSIC YAML - High-performance YAML operations for CLASSIC
//!
//! This crate provides Rust-accelerated YAML parsing and writing operations,
...
//!
//! ## Architecture
//! - Uses classic-shared for runtime and error handling
