...
class RustAcceleratedSuspectScanner:
    ...
    def __init__(self, yamldata: ClassicScanLogsInfo) -> None:
        ...
        if self._use_rust and RustSuspectScanner is not None:
            ...
            from ClassicLib.scanning.logs.analyzers.SuspectScanner import SuspectScanner as PySuspectScannerImpl
    ...
    def check_dll_crash(crashlog_mainerror: str) -> ReportFragment:
        ...
        # Fallback to Python implementation
        from ClassicLib.scanning.logs.analyzers.SuspectScanner import SuspectScanner as PySuspectScanner
