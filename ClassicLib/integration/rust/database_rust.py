...
from ClassicLib.io.database.pool_manager import DatabasePoolManager  # noqa: E402
from ClassicLib.io.database.rust_pool import (  # noqa: E402
    RUST_AVAILABLE,
...
def get_database_pool_implementation() -> type[Any]:
    ...
    try:
        from ClassicLib.io.database.async_pool import AsyncDatabasePool as PythonAsyncDatabasePool
