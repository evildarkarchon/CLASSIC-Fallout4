...
@dataclass
class PapyrusStats:
    """Represent statistics associated with Papyrus, including performance and
    error metrics.
    ...
    def __eq__(self, other: object) -> bool:
        """Compare this `PapyrusStats` instance for equality with another object.
    ...
    def __hash__(self) -> int:
        """Return a hash value for this `PapyrusStats` instance.
...
class PapyrusMonitorWorker(QObject):
    """Handle monitoring and analysis of logging stats generated by the Papyrus system.
    ...
    def stop(self) -> None:
        """Stop the running process controlled by this method. This method sets an internal
    ...
    def _parse_stats(message: str, dump_count: int) -> PapyrusStats:
        """Parse a diagnostic message to gather statistics about dumps, stacks,
