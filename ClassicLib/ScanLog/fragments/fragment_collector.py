...
class FragmentCollector:
    ...
    def extend(self, lines: list[str] | tuple[str, ...]) -> None:
        """Extend the internal collection of pending lines with the provided lines.
    ...
    def insert(self, index: int, line: str) -> None:
        """Insert a line into the object's data at the given index. This method ensures
    ...
    def _flush_pending(self) -> None:
        """Process and flushes any pending lines to create a new report fragment.
    ...
    def to_fragment(self) -> ReportFragment:
        """Convert the current state of the report into a ReportFragment.
    ...
    def to_list(self) -> list[str]:
        """Convert the object into a list of strings using its fragment representation.
    ...
    def __len__(self) -> int:
        """Calculate the total length of the content held within the object.
