...
For Rust-accelerated versions (recommended), import from ClassicLib.integration.rust.report_rust:
    from ClassicLib.integration.rust.report_rust import ReportFragment, ReportComposer, ReportGenerator
"""
