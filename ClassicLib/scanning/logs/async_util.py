...
Deprecated:
    ...
    ClassicLib.io.database. Import from there instead:

    ```python
    from ClassicLib.io.database import DatabasePoolManager, AsyncDatabasePool
    ```
"""
...
def __getattr__(name: str) -> Any:
    ...
    if name == "DatabasePoolManager":
        warnings.warn(
            "Import DatabasePoolManager from ClassicLib.io.database instead of "
    ...
    if name == "AsyncDatabasePool":
        warnings.warn(
            "Import AsyncDatabasePool from ClassicLib.io.database instead of "
            "ClassicLib.ScanLog.AsyncUtil. This import path will be removed in a future version.",
            DeprecationWarning,
            stacklevel=2,
        )
