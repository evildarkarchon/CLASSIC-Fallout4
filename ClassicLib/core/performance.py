...
def timed_operation(name: str | None = None, log_level: str = "info") -> Callable[[F], F]:
    """Decorate function to measure the execution time of a function, log the duration,
...
def async_timed_operation(name: str | None = None, log_level: str = "info") -> Callable[[F], F]:
    """Decorate measure and log the duration of asynchronous operations. This decorator
...
def batch_operation_monitor(operation_name: str) -> Callable[[F], F]:
    """Decorate function used for monitoring the performance of batch operations. It measures
...
def _store_metric(name: str, duration: float) -> None:
    """Store a performance metric by associating a metric name with a duration value.
...
def get_performance_summary() -> dict[str, dict[str, float]]:
    """Calculate and summarizes performance metrics for various operations.
...
def log_performance_summary() -> None:
    """Log a summary of performance metrics collected during the execution.
...
class TimedBlock:
    ...
    def __init__(self, name: str, log_level: str = "info") -> None:
        """Initialize the instance of the class with the provided name and log level.
