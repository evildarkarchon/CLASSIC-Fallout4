...
Rust-Accelerated Components:
    ...
    - classic_registry: Global registry (mandatory, Rust-backed storage)
    ...
    Optional modules have a RUST_*_AVAILABLE flag. classic_registry is always required.
"""

# Rust-Accelerated Components
# classic_registry is mandatory (imported directly in core/registry.py)
