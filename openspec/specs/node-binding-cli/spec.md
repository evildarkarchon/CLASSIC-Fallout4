...
Define the maintained Node binding CLI behavior for end-to-end crash log scanning, native-style scan controls, exit semantics, and automation-friendly package usage.
