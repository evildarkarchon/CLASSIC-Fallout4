...
Define requirements for a Rust-mandatory Python runtime, including fail-fast startup behavior, Rust-only integration resolution, and consistent binding diagnostics.
