...
Define the audit criteria that determine whether Python binding crates remain thin wrappers over Rust core functionality and keep parity artifacts aligned with any binding API changes.
