...
GENERATE_BASELINE_PATH = REPO_ROOT / "tools" / "python_api_parity" / "generate_baseline.py"
...
def test_parse_python_surface_tracks_method_export_paths(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(module, "PYTHON_TARGET_MODULES", {"sample_module": "sample_module.pyi"})
