...
from ClassicLib.core.registry import get_game, get_local_dir
from ClassicLib.integration.factory import get_file_io

# ResourceLoader is imported lazily inside methods to avoid circular imports
    ...
    def get_path_for_store(yaml_store: YAML) -> Path:
        ...
        match yaml_store:
            ...
            case YAML.TEST:
                ...
                return Path(get_local_dir()) / "tests" / "test_settings.yaml"
            case YAML.Cache:
