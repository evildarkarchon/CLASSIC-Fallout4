...
class FolderManagementMixin:
    ...
    def open_settings(self) -> None:
        ...
        Notepad++.
        """
        settings_file: Path = cast("Path", get_local_dir()) / "CLASSIC Settings.yaml"
    ...
    def open_backup_folder() -> None:
        ...
        """
        backup_folder: Path = cast("Path", get_local_dir()) / "CLASSIC Backup"
    ...
    def open_crash_logs_folder() -> None:
        ...
        """
        crash_logs_folder: Path = cast("Path", get_local_dir()) / "Crash Logs"
