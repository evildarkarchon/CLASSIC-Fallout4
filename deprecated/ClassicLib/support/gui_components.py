"""Define a QObject-based class for handling manual documentation paths and game paths for configuration updates.
...
class ManualDocsPath(QObject):
    """Handle the management and validation of directory paths related to manual documentation and game files.
    ...
    def get_manual_docs_path_gui(self, path: str) -> None:
        """Ensure the provided path is valid for the manual documentation directory of a game.
    ...
    def get_game_path_gui(self, path: str) -> None:
        """Determine if the input path is a valid directory. If valid, updates a settings YAML file with
