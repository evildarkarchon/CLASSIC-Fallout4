...
CORE_TARGET_REL = "business-logic/classic-scanlog-core/src/lib.rs"
BRIDGE_TARGET_REL = "cpp-bindings/classic-cpp-bridge/src/scanner.rs"
...
def main() -> int:
    ...
    if all_detected:
        print("TRIPLE-GATE TEST: PASS -- all three gates detected the canary")
        return 0
    else:
        passed_gates = [name for name, rc in gate_results.items() if rc == 0]
        print(
