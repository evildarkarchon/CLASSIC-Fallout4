...
from ClassicLib.scanning.game.check_crashgen import (
    CrashgenChecker,
...
class TestGetPluginsPath:
    ...
    def test_get_plugins_path_returns_path_from_yaml(self, mock_get_vr: MagicMock, mock_yaml: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_plugins_path_returns_none_when_not_configured(self, mock_get_vr: MagicMock, mock_yaml: MagicMock) -> None:
...
class TestGetCrashgenName:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_crashgen_name_returns_name_from_yaml(self, mock_get_vr: MagicMock, mock_yaml: MagicMock) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_crashgen_name_defaults_to_buffout4(self, mock_get_vr: MagicMock, mock_yaml: MagicMock) -> None:
...
class TestFindConfigFile:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_find_config_file_returns_none_when_no_plugins_path(
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_find_config_file_finds_og_config(
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="VR")
    def test_find_config_file_finds_vr_config(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_find_config_file_warns_about_duplicate_configs(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
...
class TestDetectInstalledPlugins:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_detect_installed_plugins_returns_set(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_detect_installed_plugins_lowercases_names(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_detect_installed_plugins_returns_empty_when_no_path(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock
    ) -> None:
...
class TestHasPlugin:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_has_plugin_returns_true_when_found(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_has_plugin_returns_false_when_not_found(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_has_plugin_checks_multiple_names(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
...
class TestGetSettingsToCheck:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="SkyrimSE")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_settings_to_check_returns_empty_for_non_fallout4(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_settings_to_check_returns_list_for_fallout4(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_settings_to_check_includes_achievements_setting(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock
    ) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_get_settings_to_check_includes_f4ee_setting(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock
    ) -> None:
...
class TestCheck:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_check_returns_tuple(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_check_returns_notice_when_no_config_file(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.mod_toml_config")
    @patch("ClassicLib.scanning.game.check_crashgen.yaml_settings")
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_check_detects_issues_without_modifying_files(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, mock_toml: MagicMock, tmp_path: Path
    ) -> None:
...
class TestCheckCrashgenSettings:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_check_crashgen_settings_returns_tuple(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock) -> None:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.CrashgenChecker")
...
class TestFCXReadOnlyCompliance:
    ...
    @patch("ClassicLib.scanning.game.check_crashgen.get_game", return_value="Fallout4")
    @patch("ClassicLib.scanning.game.check_crashgen.get_vr", return_value="")
    def test_check_only_detects_issues_never_fixes(
        self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, tmp_path: Path
    ) -> None:
