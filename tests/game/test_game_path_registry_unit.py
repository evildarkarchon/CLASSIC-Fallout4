...
class TestRegistryDetection:
    ...
    def test_registry_detection_both_keys_fail(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_open: MagicMock, message_handler) -> None:
    ...
    @patch.object(GlobalRegistry, 'get_game', return_value='Fallout4')
    @patch.object(GlobalRegistry, 'get_vr', return_value='')
    def test_registry_detection_null_path(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_close: MagicMock, mock_query: MagicMock, mock_open: MagicMock, message_handler) -> None:
