...
class TestRegistryDetection:
    ...
    def test_registry_detection_bethesda_success(self, mock_register: MagicMock, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, mock_close: MagicMock, mock_query: MagicMock, mock_open: MagicMock, tmp_path: Path) -> None:
    ...
    @patch.object(GlobalRegistry, 'get_vr', return_value='')
    @patch.object(GlobalRegistry, 'register')
    def test_registry_detection_gog_fallback_success(self, mock_register: MagicMock, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_yaml: MagicMock, mock_close: MagicMock, mock_query: MagicMock, mock_open: MagicMock, tmp_path: Path) -> None:
    ...
    @patch.object(GlobalRegistry, 'get_game', return_value='Fallout4')
    @patch.object(GlobalRegistry, 'get_vr', return_value='')
    def test_registry_detection_invalid_path(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_close: MagicMock, mock_query: MagicMock, mock_open: MagicMock, tmp_path: Path) -> None:
