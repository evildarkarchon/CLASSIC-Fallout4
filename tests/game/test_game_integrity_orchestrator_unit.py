"""Unit tests for ClassicLib.ScanGame.GameIntegrityOrchestrator module.
...
class TestGameIntegrityOrchestratorCoreInit:
    ...
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.get_file_io")
...
class TestGenerateGameCombinedResultAsync:
    ...
    @pytest.mark.asyncio
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.get_file_io")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.yaml_settings")
    ...
    @pytest.mark.asyncio
    @patch("ClassicLib.ScanGame.ScanModInis.detect_all_ini_issues_async")
    @patch("ClassicLib.ScanGame.Config.ConfigFileCache")
    @patch("ClassicLib.ScanGame.ScanGameCore.ScanGameCore")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.scan_mod_inis_async")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.scan_wryecheck")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.check_crashgen_settings")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.check_xse_plugins")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.get_file_io")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.GlobalRegistry")
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.yaml_settings")
...
class TestSingletonAndModuleFunctions:
    ...
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator._game_integrity_orchestrator_core", None)
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.get_file_io")
    ...
    @pytest.mark.asyncio
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.get_game_integrity_orchestrator_core")
...
class TestSyncAdapters:
    ...
    @patch("ClassicLib.ScanGame.GameIntegrityOrchestrator.AsyncBridge")
