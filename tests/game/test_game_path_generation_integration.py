...
class TestGamePathGeneration:
    ...
    def test_generate_paths_fallout4_vr(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_get_version: MagicMock, mock_yaml: MagicMock, tmp_path: Path) -> None:
    ...
    def test_generate_paths_unsupported_version(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_get_version: MagicMock, mock_yaml: MagicMock, tmp_path: Path) -> None:
