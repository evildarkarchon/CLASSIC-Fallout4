...
class TestGamePathDetection:
    ...
    @patch.object(GlobalRegistry, "get_game", return_value="Fallout4")
    @patch.object(GlobalRegistry, "get_vr", return_value="")
    def test_registry_detection_both_keys_fail(self, mock_get_vr: MagicMock, mock_get_game: MagicMock, mock_open: MagicMock) -> None:
    ...
    def test_game_path_find_manual_input_success(
        self, mock_input: MagicMock, mock_msg_info: MagicMock, mock_msg_error: MagicMock, tmp_path: Path
    ) -> None:
        ...
        with patch("ClassicLib.GamePath.yaml_settings") as mock_yaml:
            ...
            with patch("ClassicLib.GamePath._game_path_find_registry", return_value=None):  # Registry fails
