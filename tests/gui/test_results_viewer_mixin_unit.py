...
class TestResultsViewerMixinInit:
    ...
    def test_setup_results_tab_initializes_components(self, viewer_mixin):
        """Should initialize all required components."""
        with patch.object(viewer_mixin, "_create_reports_panel") as mock_reports_panel, \
    ...
    def test_create_reports_panel_sets_up_list_and_buttons(self, viewer_mixin):
    ...
    def test_create_viewer_panel_sets_up_viewer_components(self, viewer_mixin):
        """Should create viewer panel with markdown viewer and metadata."""
        with patch("ClassicLib.Interface.ResultsViewerWidgets.MarkdownViewer") as mock_markdown, \
...
class TestReportScanning:
    ...
    def test_scan_for_reports_finds_autoscan_files(self, viewer_mixin, tmp_path):
    ...
    def test_scan_for_reports_handles_custom_path(self, viewer_mixin, tmp_path):
    ...
    def test_scan_for_reports_sorts_by_modification_time(self, viewer_mixin, tmp_path):
...
class TestReportLoading:
    ...
    def test_load_report_success(self, viewer_mixin, tmp_path):
    ...
    def test_load_report_file_not_found(self, viewer_mixin):
    ...
    def test_load_report_handles_encoding_errors(self, viewer_mixin, tmp_path):
...
class TestReportManagement:
    ...
    def test_delete_selected_report_with_confirmation(self, viewer_mixin):
        ...
        mock_report_path.with_suffix.return_value = MagicMock(exists=MagicMock(return_value=False))
    ...
    def test_delete_selected_report_cancelled(self, viewer_mixin, tmp_path):
    ...
    def test_copy_report_to_clipboard(self, viewer_mixin, tmp_path):
    ...
    def test_open_reports_folder(self, viewer_mixin, tmp_path):
...
class TestAutoRefresh:
    ...
    def test_setup_auto_refresh_enabled(self, viewer_mixin):
    ...
    def test_setup_auto_refresh_disabled(self, viewer_mixin):
    ...
    def test_directory_changed_triggers_debounced_refresh(self, viewer_mixin):
