...
class TestSettingsLoading:
    ...
    def test_load_all_settings(self, settings_dialog, reset_settings):
        ...
        test_values = {'CLASSIC_Settings.Audio Notifications': False, 'CLASSIC_Settings.VR Mode': True, 'CLASSIC_Settings.FCX Mode': True, 'CLASSIC_Settings.Simplify Logs': True, 'CLASSIC_Settings.Show FormID Values': False, 'CLASSIC_Settings.Move Unsolved Logs': True, 'CLASSIC_Settings.Update Check': True}
