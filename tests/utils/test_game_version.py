...
class TestGameVersionDetection:
    ...
    @patch("platform.system", return_value="Windows")
    @patch("ClassicLib.Util._get_version_from_pe_header")
    @patch("ClassicLib.Util._get_version_windows_api", return_value=Constants.NULL_VERSION)
    ...
    @patch("platform.system", return_value="Windows")
    @patch("ClassicLib.Util._get_version_windows_api", return_value=Constants.NULL_VERSION)
    @patch("ClassicLib.Util._get_version_from_pe_header", return_value=Constants.NULL_VERSION)
