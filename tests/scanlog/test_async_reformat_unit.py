"""Unit tests for ClassicLib.scanning.logs.async_reformat module.
...
class TestReformatSingleLogAsync:
    ...
    async def test_reformats_plugin_section_brackets(self, tmp_path: Path) -> None:
        ...
        from ClassicLib.scanning.logs.async_reformat import reformat_single_log_async
...
class TestCrashlogsReformatAsync:
    ...
    async def test_processes_all_logs_in_list(self, tmp_path: Path) -> None:
        ...
        with patch("ClassicLib.scanning.logs.async_reformat.classic_settings_async", return_value=False):
    ...
    async def test_respects_simplify_logs_setting(self, tmp_path: Path) -> None:
        ...
        with patch("ClassicLib.scanning.logs.async_reformat.classic_settings_async", return_value=True):
...
class TestBatchFileMoveAsync:
    ...
    async def test_moves_all_files(self, tmp_path: Path) -> None:
        ...
        from ClassicLib.scanning.logs.async_reformat import batch_file_move_async
...
class TestBatchFileCopyAsync:
    ...
    async def test_copies_all_files(self, tmp_path: Path) -> None:
        ...
        from ClassicLib.scanning.logs.async_reformat import batch_file_copy_async
