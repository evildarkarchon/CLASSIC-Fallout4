...
class TestBackupManager:
    ...
    def test_extract_xse_version_success(
    ...
    def test_extract_xse_version_file_not_found(
        self, mock_logger: MagicMock, mock_open: MagicMock, manager: BackupManager
    ) -> None:
    ...
    @patch("ClassicLib.BackupManager.open_file_with_encoding")
    @patch("ClassicLib.BackupManager.normalize_list")
    def test_extract_xse_version_empty_log(
        self, mock_normalize: MagicMock, mock_open_file: MagicMock, manager: BackupManager
    ) -> None:
    ...
    def test_create_backup_directory_with_logging(
        self, mock_logger: MagicMock, manager: BackupManager, tmp_path: Path
    ) -> None:
    ...
    def test_backup_files_success(
        self, mock_copy: MagicMock, mock_validate: MagicMock, manager: BackupManager, tmp_path: Path
    ) -> None:
    ...
    @patch("ClassicLib.Util.validate_path")
    @patch("ClassicLib.BackupManager.logger")
    def test_backup_files_invalid_source(
        self, mock_logger: MagicMock, mock_validate: MagicMock, manager: BackupManager
    ) -> None:
    ...
    @patch.object(BackupManager, "load_backup_configuration")
    def test_run_backup_loads_config_if_missing(
        self, mock_load: MagicMock, manager: BackupManager
    ) -> None:
    ...
    @patch("ClassicLib.BackupManager.logger")
    def test_run_backup_no_xse_log_configured(
    ...
    @patch.object(BackupManager, "extract_xse_version")
    @patch("ClassicLib.BackupManager.logger")
    def test_run_backup_no_xse_version(
        self, mock_logger: MagicMock, mock_extract: MagicMock, manager: BackupManager
    ) -> None:
    ...
    @patch.object(BackupManager, "extract_xse_version")
    @patch("ClassicLib.BackupManager.logger")
    def test_run_backup_missing_config(
        self, mock_logger: MagicMock, mock_extract: MagicMock, manager: BackupManager
    ) -> None:
