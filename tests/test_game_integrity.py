...
class TestGameIntegrityChecker:
    ...
    def test_check_executable_version_no_exe(
        self, checker: GameIntegrityChecker, mock_config: dict[str, str]
    ) -> None:
    ...
    def test_check_executable_version_no_path_configured(
        self, checker: GameIntegrityChecker
    ) -> None:
    ...
    def test_check_installation_location_good(
        self, checker: GameIntegrityChecker, mock_config: dict[str, str], tmp_path: Path
    ) -> None:
    ...
    def test_check_installation_location_bad(
        self, checker: GameIntegrityChecker, mock_config: dict[str, str]
    ) -> None:
    ...
    def test_check_installation_location_no_exe(
        self, checker: GameIntegrityChecker, mock_config: dict[str, str]
    ) -> None:
    ...
    def test_check_installation_location_no_warning_configured(
        self, checker: GameIntegrityChecker, mock_config: dict[str, str]
    ) -> None:
    ...
    @patch("ClassicLib.GameIntegrity.logger")
    def test_run_full_check_logging(
        self, mock_logger: MagicMock, checker: GameIntegrityChecker
    ) -> None:
