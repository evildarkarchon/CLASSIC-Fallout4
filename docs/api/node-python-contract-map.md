...
- `classic_scangame.run_game_setup_intake(...)` returns concrete `GameSetupPathUpdate` records alongside `path_update_count`; the caller decides whether any proposal becomes a User Settings Update
