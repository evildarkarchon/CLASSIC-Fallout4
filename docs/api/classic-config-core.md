...
- `LocalIgnoreYamlDataState::{Existing, Generated}` plus the exact authoritative Local Ignore SHA-256 identity and byte length;
- structured cache, rejected-candidate, and `LocalIgnoreGenerated` diagnostics.
