...
| `classic-settings-core` (historical note: absorbed the former `classic-yaml-core` in v9.1.0 Phase 1) | [`settings.rs`](../../ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/settings.rs) | [`settings.rs`](../../ClassicLib-rs/node-bindings/classic-node/src/settings.rs) | [`classic-settings-py`](../../ClassicLib-rs/python-bindings/classic-settings-py/) |
