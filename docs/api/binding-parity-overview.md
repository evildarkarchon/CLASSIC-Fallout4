...
| `classic-config-core` (absorbed the former crashgen rules crate in v9.1.0 Phase 2 — rule model now at `classic_config_core::crashgen_rules::*`) | [`config.rs`](../../ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/config.rs) | [`config.rs`](../../ClassicLib-rs/node-bindings/classic-node/src/config.rs) + [`crashgen_rules.rs`](../../ClassicLib-rs/node-bindings/classic-node/src/crashgen_rules.rs) | [`classic-config-py`](../../ClassicLib-rs/python-bindings/classic-config-py/) (plus crashgen-rule surfaces in [`classic-scanlog-py`](../../ClassicLib-rs/python-bindings/classic-scanlog-py/) and [`classic-scangame-py`](../../ClassicLib-rs/python-bindings/classic-scangame-py/)) |
