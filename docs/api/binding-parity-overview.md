...
CLI, GUI, and TUI emit separate shadow consumer receipts for their maintained Display Content, routing, interaction, and presentation obligations. These receipts preserve typed path/count carriers and are validated against source-owned obligation profiles; they cannot satisfy semantic adapter parity rows or authorize frontend recomposition of Rust-owned wording.
