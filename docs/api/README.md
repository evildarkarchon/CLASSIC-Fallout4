...
7. [`classic-settings-core.md`](classic-settings-core.md) - YAML settings cache plus sync/async raw-document loading helpers
...
29. [`binding-parity-overview.md`](binding-parity-overview.md) - current C++ bridge, Node, and Python exposure comparison for shared Rust crates
...
- `classic-settings-core` provides raw YAML settings loading plus a sync/async cache layer keyed by caller-chosen strings
