...
6a. [`classic-user-settings-core.md`](classic-user-settings-core.md) - typed, preservation-aware User Settings discovery, Update Preferences, Crash Log Scan settings, Game Setup settings, Frontend State, diagnostics, revision, and non-persisting update previews
