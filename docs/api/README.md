...
6a. [`classic-user-settings-core.md`](classic-user-settings-core.md) - typed, preservation-aware User Settings discovery, cohesive groups, revision-anchored update previews, and conflict-safe atomic commits
...
- `classic-user-settings-core` owns root-relative User Settings discovery, typed cohesive groups, safe defaults/fallbacks, diagnostics, content revisions, semantic preservation, and conflict-safe atomic persistence; adapters retain presentation and consent
