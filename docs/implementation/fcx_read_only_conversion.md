...
#### classic-scanlog-core/src/fcx_handler.rs
**Lines affected**: Entire file
...
#### classic-scanlog-py/src/fcx_handler.rs
**Lines affected**: Entire file
...
1. Update `classic-scanlog-core/src/fcx_handler.rs`:
   - Remove fix-related state
   - Add `ConfigIssue` struct
   - Update state management
2. Update `classic-scanlog-py/src/fcx_handler.rs`:
...
- **Rust Core**: [classic-scanlog-core/src/fcx_handler.rs](../../classic-scanlog-core/src/fcx_handler.rs)
- **Rust PyO3**: [classic-scanlog-py/src/fcx_handler.rs](../../classic-scanlog-py/src/fcx_handler.rs)
