...
- Generated: `2026-09-08T07:25:37.261205+00:00`
...
|---|---|---|---|---|
| `shared.lib.GameId.display_name` | `shared` | `GameId` | `classic_shared.GameId.display_name` | `matched` |
| `message.lib.init_logging` | `message` | `init` | `classic_message.init_logging` | `matched` |
...
| `scanlog.scan_run.ScanRunCancellation.__init__` | `scanlog` | `Cancellation` | `classic_scanlog.ScanRunCancellation.__init__` | `matched` |
| `scanlog.scan_run.ScanRunCancellation.cancel` | `scanlog` | `Cancellation` | `classic_scanlog.ScanRunCancellation.cancel` | `matched` |
...
| `user_settings.classification_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.classification` | `matched` |
| `user_settings.diagnostic_code_accessor` | `user_settings` | `Diagnostic` | `classic_user_settings.UserSettingsDiagnostic.code` | `matched` |
| `user_settings.commit_eligibility_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.commit_eligibility` | `matched` |
| `user_settings.diagnostics_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.diagnostics` | `matched` |
| `user_settings.location_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.source_location` | `matched` |
| `user_settings.diagnostic_message_accessor` | `user_settings` | `Diagnostic` | `classic_user_settings.UserSettingsDiagnostic.message` | `matched` |
...
| `user_settings.original_bytes_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.original_content` | `matched` |
| `user_settings.path_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.source_path` | `matched` |
| `user_settings.revision_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.revision` | `matched` |
...
| `user_settings.update_check_accessor` | `user_settings` | `UpdatePreferences` | `classic_user_settings.UpdatePreferences.update_check` | `matched` |
| `user_settings.update_check_origin_accessor` | `user_settings` | `UpdatePreferences` | `classic_user_settings.UpdatePreferences.origin` | `matched` |
| `user_settings.update_source_accessor` | `user_settings` | `UpdatePreferences` | `classic_user_settings.UpdatePreferences.update_source` | `matched` |
| `user_settings.update_source_origin_accessor` | `user_settings` | `UpdatePreferences` | `classic_user_settings.UpdatePreferences.update_source_origin` | `matched` |
| `user_settings.update_preferences_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.update_preferences` | `matched` |
...
| `user_settings.crash_log_scan_settings_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.crash_log_scan_settings` | `matched` |
| `user_settings.scan_fcx_mode_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.fcx_mode` | `matched` |
| `user_settings.scan_fcx_mode_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.fcx_mode_origin` | `matched` |
| `user_settings.scan_simplify_logs_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.simplify_logs` | `matched` |
| `user_settings.scan_simplify_logs_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.simplify_logs_origin` | `matched` |
| `user_settings.scan_show_statistics_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.show_statistics` | `matched` |
| `user_settings.scan_show_statistics_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.show_statistics_origin` | `matched` |
| `user_settings.scan_formid_value_lookup_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.formid_value_lookup` | `matched` |
| `user_settings.scan_formid_value_lookup_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.formid_value_lookup_origin` | `matched` |
| `user_settings.scan_formid_databases_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.formid_databases` | `matched` |
| `user_settings.scan_formid_databases_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.formid_databases_origin` | `matched` |
| `user_settings.scan_move_unsolved_logs_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.move_unsolved_logs` | `matched` |
| `user_settings.scan_move_unsolved_logs_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.move_unsolved_logs_origin` | `matched` |
| `user_settings.scan_unsolved_logs_destination_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.unsolved_logs_destination` | `matched` |
| `user_settings.scan_unsolved_logs_destination_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.unsolved_logs_destination_origin` | `matched` |
| `user_settings.scan_custom_scan_input_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.custom_scan_input` | `matched` |
| `user_settings.scan_custom_scan_input_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.custom_scan_input_origin` | `matched` |
| `user_settings.scan_game_version_selection_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.game_version_selection` | `matched` |
| `user_settings.scan_game_version_selection_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.game_version_selection_origin` | `matched` |
| `user_settings.scan_max_concurrent_scans_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.max_concurrent_scans` | `matched` |
| `user_settings.scan_max_concurrent_scans_origin_accessor` | `user_settings` | `CrashLogScanSettings` | `classic_user_settings.CrashLogScanSettings.max_concurrent_scans_origin` | `matched` |
...
| `user_settings.update_new` | `user_settings` | `UserSettingsUpdate` | `classic_user_settings.UserSettingsUpdate.__init__` | `matched` |
...
| `user_settings.accepted_base_revision_accessor` | `user_settings` | `UserSettingsUpdatePreview` | `classic_user_settings.UserSettingsUpdatePreview.base_revision` | `matched` |
| `user_settings.accepted_fields_accessor` | `user_settings` | `UserSettingsUpdatePreview` | `classic_user_settings.UserSettingsUpdatePreview.fields` | `matched` |
| `user_settings.update_field_canonical_path_accessor` | `user_settings` | `UserSettingsUpdateField` | `classic_user_settings.UserSettingsUpdateField.canonical_path` | `matched` |
| `user_settings.update_diagnostic_field_path_accessor` | `user_settings` | `UpdateDiagnostic` | `classic_user_settings.UserSettingsUpdateDiagnostic.field_path` | `matched` |
| `user_settings.update_diagnostic_code_accessor` | `user_settings` | `UpdateDiagnostic` | `classic_user_settings.UserSettingsUpdateDiagnostic.code` | `matched` |
| `user_settings.update_diagnostic_message_accessor` | `user_settings` | `UpdateDiagnostic` | `classic_user_settings.UserSettingsUpdateDiagnostic.message` | `matched` |
| `user_settings.game_setup_settings_type` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings` | `matched` |
| `user_settings.game_setup_settings_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.game_setup_settings` | `matched` |
| `user_settings.setup_managed_game_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.managed_game` | `matched` |
| `user_settings.setup_managed_game_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.managed_game_origin` | `matched` |
| `user_settings.setup_game_version_selection_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_version_selection` | `matched` |
| `user_settings.setup_game_version_selection_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_version_selection_origin` | `matched` |
| `user_settings.setup_game_root_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_root` | `matched` |
| `user_settings.setup_game_root_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_root_origin` | `matched` |
| `user_settings.setup_game_executable_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_executable` | `matched` |
| `user_settings.setup_game_executable_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.game_executable_origin` | `matched` |
| `user_settings.setup_documents_root_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.documents_root` | `matched` |
| `user_settings.setup_documents_root_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.documents_root_origin` | `matched` |
| `user_settings.setup_ini_folder_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.ini_folder` | `matched` |
| `user_settings.setup_ini_folder_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.ini_folder_origin` | `matched` |
| `user_settings.setup_mods_root_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.mods_root` | `matched` |
| `user_settings.setup_mods_root_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.mods_root_origin` | `matched` |
| `user_settings.setup_custom_scan_input_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.custom_scan_input` | `matched` |
| `user_settings.setup_custom_scan_input_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.custom_scan_input_origin` | `matched` |
| `user_settings.setup_papyrus_log_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.papyrus_log` | `matched` |
| `user_settings.setup_papyrus_log_origin_accessor` | `user_settings` | `GameSetupSettings` | `classic_user_settings.GameSetupSettings.papyrus_log_origin` | `matched` |
...
| `user_settings.frontend_state_accessor` | `user_settings` | `UserSettings` | `classic_user_settings.UserSettingsSnapshot.frontend_state` | `matched` |
| `user_settings.frontend_preferences_accessor` | `user_settings` | `FrontendState` | `classic_user_settings.FrontendState.preferences` | `matched` |
| `user_settings.frontend_window_geometry_accessor` | `user_settings` | `FrontendState` | `classic_user_settings.FrontendState.window_geometry` | `matched` |
| `user_settings.frontend_tui_accessor` | `user_settings` | `FrontendState` | `classic_user_settings.FrontendState.tui` | `matched` |
| `user_settings.frontend_auto_switch_after_scan_accessor` | `user_settings` | `FrontendPreferences` | `classic_user_settings.FrontendPreferences.auto_switch_after_scan` | `matched` |
| `user_settings.frontend_auto_switch_after_scan_origin_accessor` | `user_settings` | `FrontendPreferences` | `classic_user_settings.FrontendPreferences.auto_switch_after_scan_origin` | `matched` |
| `user_settings.frontend_auto_refresh_interval_ms_accessor` | `user_settings` | `FrontendPreferences` | `classic_user_settings.FrontendPreferences.auto_refresh_interval_ms` | `matched` |
| `user_settings.frontend_auto_refresh_interval_ms_origin_accessor` | `user_settings` | `FrontendPreferences` | `classic_user_settings.FrontendPreferences.auto_refresh_interval_ms_origin` | `matched` |
| `user_settings.frontend_main_tab_accessor` | `user_settings` | `GuiWindowGeometry` | `classic_user_settings.GuiWindowGeometry.main_tab` | `matched` |
| `user_settings.frontend_backups_tab_accessor` | `user_settings` | `GuiWindowGeometry` | `classic_user_settings.GuiWindowGeometry.backups_tab` | `matched` |
| `user_settings.frontend_articles_tab_accessor` | `user_settings` | `GuiWindowGeometry` | `classic_user_settings.GuiWindowGeometry.articles_tab` | `matched` |
| `user_settings.frontend_results_tab_accessor` | `user_settings` | `GuiWindowGeometry` | `classic_user_settings.GuiWindowGeometry.results_tab` | `matched` |
| `user_settings.frontend_window_maximized_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.maximized` | `matched` |
| `user_settings.frontend_window_maximized_origin_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.maximized_origin` | `matched` |
| `user_settings.frontend_window_width_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.width` | `matched` |
| `user_settings.frontend_window_width_origin_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.width_origin` | `matched` |
| `user_settings.frontend_window_height_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.height` | `matched` |
| `user_settings.frontend_window_height_origin_accessor` | `user_settings` | `WindowGeometry` | `classic_user_settings.WindowGeometry.height_origin` | `matched` |
| `user_settings.frontend_tui_active_tab_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.active_tab` | `matched` |
| `user_settings.frontend_tui_active_tab_origin_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.active_tab_origin` | `matched` |
| `user_settings.frontend_tui_results_panel_width_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.results_panel_width` | `matched` |
| `user_settings.frontend_tui_results_panel_width_origin_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.results_panel_width_origin` | `matched` |
| `user_settings.frontend_tui_sort_ascending_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.sort_ascending` | `matched` |
| `user_settings.frontend_tui_sort_ascending_origin_accessor` | `user_settings` | `TuiRememberedState` | `classic_user_settings.TuiRememberedState.sort_ascending_origin` | `matched` |
...
| `user_settings.migration_plan_base_revision` | `user_settings` | `UserSettingsMigrationPlan` | `classic_user_settings.UserSettingsMigrationPlan.base_revision` | `matched` |
| `user_settings.migration_plan_changes` | `user_settings` | `UserSettingsMigrationPlan` | `classic_user_settings.UserSettingsMigrationPlan.changes` | `matched` |
| `user_settings.migration_plan_original_bytes` | `user_settings` | `UserSettingsMigrationPlan` | `classic_user_settings.UserSettingsMigrationPlan.original_content` | `matched` |
| `user_settings.migration_plan_proposed_bytes` | `user_settings` | `UserSettingsMigrationPlan` | `classic_user_settings.UserSettingsMigrationPlan.proposed_content` | `matched` |
| `user_settings.migration_change_source_path` | `user_settings` | `MigrationChange` | `classic_user_settings.UserSettingsMigrationChange.source_path` | `matched` |
| `user_settings.migration_change_target_path` | `user_settings` | `MigrationChange` | `classic_user_settings.UserSettingsMigrationChange.target_path` | `matched` |
| `user_settings.migration_change_before` | `user_settings` | `MigrationChange` | `classic_user_settings.UserSettingsMigrationChange.before` | `matched` |
| `user_settings.migration_change_after` | `user_settings` | `MigrationChange` | `classic_user_settings.UserSettingsMigrationChange.after` | `matched` |
| `user_settings.migration_diagnostic_message` | `user_settings` | `MigrationDiagnostic` | `classic_user_settings.UserSettingsMigrationDiagnostic.message` | `matched` |
...
| `database.lib.get_default_cache_cleanup_interval` | `database` | `DEFAULT_CACHE_CLEANUP_INTERVAL_SECS` | `classic_database.get_default_cache_cleanup_interval` | `matched` |
...
| `database.pool.get_batch_cache_ttl` | `database` | `BATCH_CACHE_TTL_SECS` | `classic_database.get_batch_cache_ttl` | `matched` |
| `database.pool.get_default_cache_cleanup_threshold` | `database` | `DEFAULT_CACHE_CLEANUP_OP_THRESHOLD` | `classic_database.get_default_cache_cleanup_threshold` | `matched` |
| `database.pool.get_default_cache_ttl` | `database` | `DEFAULT_CACHE_TTL_SECS` | `classic_database.get_default_cache_ttl` | `matched` |
| `database.pool.get_default_query_cache_capacity` | `database` | `DEFAULT_QUERY_CACHE_CAPACITY` | `classic_database.get_default_query_cache_capacity` | `matched` |
| `database.pool.get_max_cache_ttl` | `database` | `MAX_CACHE_TTL_SECS` | `classic_database.get_max_cache_ttl` | `matched` |
...
| `path.lib.PathValidator` | `path` | `None` | `classic_path.PathValidator` | `unmapped` |
| `path.lib.PathValidator.check_drive_exists` | `path` | `check_drive_exists` | `classic_path.PathValidator.check_drive_exists` | `matched` |
| `path.lib.PathValidator.check_read_permissions` | `path` | `check_read_permissions` | `classic_path.PathValidator.check_read_permissions` | `matched` |
| `path.lib.PathValidator.check_write_permissions` | `path` | `check_write_permissions` | `classic_path.PathValidator.check_write_permissions` | `matched` |
| `path.lib.PathValidator.is_restricted_path` | `path` | `is_restricted_path` | `classic_path.PathValidator.is_restricted_path` | `matched` |
| `path.lib.PathValidator.is_valid_executable_path` | `path` | `is_valid_executable_path` | `classic_path.PathValidator.is_valid_executable_path` | `matched` |
| `path.lib.PathValidator.is_valid_path` | `path` | `is_valid_path` | `classic_path.PathValidator.is_valid_path` | `matched` |
| `path.lib.PathValidator.validate_custom_scan_path` | `path` | `validate_custom_scan_path` | `classic_path.PathValidator.validate_custom_scan_path` | `matched` |
| `path.lib.PathValidator.validate_path_with_permissions` | `path` | `validate_path_with_permissions` | `classic_path.PathValidator.validate_path_with_permissions` | `matched` |
...
| `path.lib.PathValidator.validate_settings_path` | `path` | `validate_settings_path` | `classic_path.PathValidator.validate_settings_path` | `matched` |
| `path.lib.PathValidator.validate_settings_paths` | `path` | `validate_settings_paths` | `classic_path.PathValidator.validate_settings_paths` | `matched` |
...
| `perf.lib.reset_metrics` | `perf` | `clear_metrics` | `classic_perf.reset_metrics` | `matched` |
...
| `scangame.config_cache.RustConfigFileCache` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache` | `matched` |
| `scangame.config_cache.RustConfigFileCache.__init__` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.__init__` | `matched` |
| `scangame.config_cache.RustConfigFileCache.config_files` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.config_files` | `matched` |
| `scangame.config_cache.RustConfigFileCache.contains` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.contains` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_bool` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_bool` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_duplicates` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_duplicates` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_float` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_float` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_int` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_int` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_path` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_path` | `matched` |
| `scangame.config_cache.RustConfigFileCache.get_str` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.get_str` | `matched` |
| `scangame.config_cache.RustConfigFileCache.has_setting` | `scangame` | `ConfigFileCache` | `classic_scangame.RustConfigFileCache.has_setting` | `matched` |
| `scangame.config_cache.RustModIniScanner` | `scangame` | `ModIniScanner` | `classic_scangame.RustModIniScanner` | `matched` |
| `scangame.config_cache.RustModIniScanner.__init__` | `scangame` | `ModIniScanner` | `classic_scangame.RustModIniScanner.__init__` | `matched` |
| `scangame.config_cache.RustModIniScanner.scan` | `scangame` | `ModIniScanner` | `classic_scangame.RustModIniScanner.scan` | `matched` |
| `scangame.config_cache.VsyncEntry` | `scangame` | `VsyncEntry` | `classic_scangame.VsyncEntry` | `matched` |
| `scangame.config_cache.scan_mod_inis` | `scangame` | `ModIniScanner` | `classic_scangame.scan_mod_inis` | `matched` |
...
| `scangame.logs.process_logs` | `scangame` | `LogProcessor` | `classic_scangame.process_logs` | `matched` |
...
| `scangame.xse.check_xse_plugins` | `scangame` | `XseChecker` | `classic_scangame.check_xse_plugins` | `matched` |
...
| `scanlog.papyrus.PapyrusError@rust` | `scanlog` | `PapyrusError` | `None.None` | `matched` |
...
| `shared.path.PathHandler` | `shared` | `PathHandler` | `classic_shared.PathHandler` | `matched` |
| `shared.path.PathHandler.__init__` | `shared` | `PathHandler` | `classic_shared.PathHandler.__init__` | `matched` |
| `shared.path.PathHandler.cache_metrics` | `shared` | `PathHandler` | `classic_shared.PathHandler.cache_metrics` | `matched` |
| `shared.path.PathHandler.cache_stats` | `shared` | `PathHandler` | `classic_shared.PathHandler.cache_stats` | `matched` |
| `shared.path.PathHandler.cleanup_cache` | `shared` | `PathHandler` | `classic_shared.PathHandler.cleanup_cache` | `matched` |
| `shared.path.PathHandler.clear_cache` | `shared` | `PathHandler` | `classic_shared.PathHandler.clear_cache` | `matched` |
| `shared.path.PathHandler.common_prefix` | `shared` | `PathHandler` | `classic_shared.PathHandler.common_prefix` | `matched` |
| `shared.path.PathHandler.get_extension` | `shared` | `PathHandler` | `classic_shared.PathHandler.get_extension` | `matched` |
| `shared.path.PathHandler.get_filename` | `shared` | `PathHandler` | `classic_shared.PathHandler.get_filename` | `matched` |
| `shared.path.PathHandler.get_parent` | `shared` | `PathHandler` | `classic_shared.PathHandler.get_parent` | `matched` |
| `shared.path.PathHandler.is_absolute` | `shared` | `PathHandler` | `classic_shared.PathHandler.is_absolute` | `matched` |
| `shared.path.PathHandler.join_paths` | `shared` | `PathHandler` | `classic_shared.PathHandler.join_paths` | `matched` |
| `shared.path.PathHandler.normalize_path` | `shared` | `PathHandler` | `classic_shared.PathHandler.normalize_path` | `matched` |
| `shared.path.PathHandler.split_path` | `shared` | `PathHandler` | `classic_shared.PathHandler.split_path` | `matched` |
| `shared.path.PathHandler.split_path_fast` | `shared` | `PathHandler` | `classic_shared.PathHandler.split_path_fast` | `matched` |
| `shared.path.PathHandler.to_absolute` | `shared` | `PathHandler` | `classic_shared.PathHandler.to_absolute` | `matched` |
| `shared.path.PathHandler.validate_paths_batch` | `shared` | `PathHandler` | `classic_shared.PathHandler.validate_paths_batch` | `matched` |
| `shared.path.PathHandler.validate_paths_batch_fast` | `shared` | `PathHandler` | `classic_shared.PathHandler.validate_paths_batch_fast` | `matched` |
...
| `shared.performance.RustPerformanceMonitor` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor` | `matched` |
| `shared.performance.RustPerformanceMonitor.__init__` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.__init__` | `matched` |
| `shared.performance.RustPerformanceMonitor.clear_metrics` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.clear_metrics` | `matched` |
| `shared.performance.RustPerformanceMonitor.get_all_stats` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.get_all_stats` | `matched` |
| `shared.performance.RustPerformanceMonitor.get_operation_stats` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.get_operation_stats` | `matched` |
| `shared.performance.RustPerformanceMonitor.record_metric` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.record_metric` | `matched` |
| `shared.performance.RustPerformanceMonitor.start_timer` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.start_timer` | `matched` |
| `shared.performance.RustPerformanceMonitor.stop_timer` | `shared` | `PerformanceMetrics` | `classic_shared.RustPerformanceMonitor.stop_timer` | `matched` |
...
| `shared.runtime.get_runtime_stats` | `shared` | `get_runtime` | `classic_shared.get_runtime_stats` | `matched` |
| `shared.runtime.is_runtime_healthy` | `shared` | `get_runtime` | `classic_shared.is_runtime_healthy` | `matched` |
...
| `shared.strings.StringProcessor` | `shared` | `StringProcessor` | `classic_shared.StringProcessor` | `matched` |
| `shared.strings.StringProcessor.__init__` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.__init__` | `matched` |
| `shared.strings.StringProcessor.clear_pool` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.clear_pool` | `matched` |
| `shared.strings.StringProcessor.common_prefix` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.common_prefix` | `matched` |
| `shared.strings.StringProcessor.intern` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.intern` | `matched` |
| `shared.strings.StringProcessor.intern_batch` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.intern_batch` | `matched` |
| `shared.strings.StringProcessor.join_lines` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.join_lines` | `matched` |
| `shared.strings.StringProcessor.normalize` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.normalize` | `matched` |
| `shared.strings.StringProcessor.pool_stats` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.pool_stats` | `matched` |
| `shared.strings.StringProcessor.process_batch` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.process_batch` | `matched` |
| `shared.strings.StringProcessor.process_batch_fast` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.process_batch_fast` | `matched` |
| `shared.strings.StringProcessor.split_lines` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.split_lines` | `matched` |
| `shared.strings.StringProcessor.split_lines_fast` | `shared` | `StringProcessor` | `classic_shared.StringProcessor.split_lines_fast` | `matched` |
...
| `config.main_yaml_version.load_main_yaml_version` | `config` | `load_main_yaml_version_with_bundled_dir` | `classic_config.load_main_yaml_version` | `matched` |
| `user_settings.legacy_tui_import` | `user_settings` | `import_legacy_tui_state` | `classic_user_settings.import_legacy_tui_state_into_user_settings` | `matched` |
| `user_settings.legacy_tui_restore` | `user_settings` | `LegacyTuiStateImportReceipt` | `classic_user_settings.LegacyTuiStateImportReceipt.restore` | `matched` |
| `user_settings.LegacyTuiStateImportReceipt` | `user_settings` | `LegacyTuiStateImportReceipt` | `classic_user_settings.LegacyTuiStateImportReceipt` | `matched` |
| `user_settings.LegacyTuiStateImportOutcome` | `user_settings` | `LegacyTuiStateImportOutcome` | `classic_user_settings.LegacyTuiStateImportOutcome` | `matched` |
| `user_settings.LegacyTuiStateImportRestoreOutcome` | `user_settings` | `LegacyTuiStateImportRestoreOutcome` | `classic_user_settings.LegacyTuiStateImportRestoreOutcome` | `matched` |
| `scanlog.crash_pattern.detect_crash_pattern` | `scanlog` | `detect_crash_pattern` | `classic_scanlog.detect_crash_pattern` | `matched` |
| `scanlog.formid_finding_analyzer.FormIDFindingAnalyzer.in_memory` | `scanlog` | `FormIDFindingAnalyzer` | `classic_scanlog.FormIDFindingAnalyzer.in_memory` | `matched` |
| `scanlog.formid_finding_analyzer.FormIDFindingAnalyzer.sqlite` | `scanlog` | `FormIDFindingAnalyzer` | `classic_scanlog.FormIDFindingAnalyzer.sqlite` | `matched` |
| `scanlog.formid_finding_analyzer.FormIDFindingLookupEntry` | `scanlog` | `FormIdValueLookupEntry` | `classic_scanlog.FormIDFindingLookupEntry` | `matched` |
| `scanlog.formid_finding_analyzer.FormIDFindingLookupEntry.__init__` | `scanlog` | `FormIdValueLookupEntry` | `classic_scanlog.FormIDFindingLookupEntry.__init__` | `matched` |
| `scanlog.formid_finding_analyzer.FormIDFindingLookupReplyKind` | `scanlog` | `FormIdValueLookupInMemoryReply` | `classic_scanlog.FormIDFindingLookupReplyKind` | `matched` |
