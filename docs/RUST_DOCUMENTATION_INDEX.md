...
- [`docs/api/classic-user-settings-core.md`](api/classic-user-settings-core.md) — typed, preservation-aware User Settings discovery and the read-only Update Preferences path
