...
- `installation-discovery-source-boundary` (structural): `python-bindings/tests/test_installation_discovery_source_audit.py`, `business-logic/classic-path-core/src/docs_path.rs`, `business-logic/classic-path-core/src/game_path.rs`, `business-logic/classic-path-core/src/platform/windows.rs`, `python-bindings/classic-path-py/src/lib.rs`
