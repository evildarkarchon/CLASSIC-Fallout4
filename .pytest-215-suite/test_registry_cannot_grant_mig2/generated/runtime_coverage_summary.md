...
- Generated: `2026-09-08T01:59:31.133875+00:00`
- Tracked surfaces: **1003**
- Unmigrated legacy registry claims: **758**
- Requiring executable receipts: **37**
- Retained structural analysis: **55**
- Contract mapped only: **153**
- Newly uncovered: **0**
- Tier-1 rows missing runtime metadata: **139**
...
| `config` | 117 | 6 | 0 | 0 | 0 | 123 |
| `database` | 20 | 1 | 2 | 0 | 0 | 23 |
| `file_io` | 24 | 0 | 0 | 0 | 0 | 24 |
| `message` | 9 | 0 | 0 | 0 | 0 | 9 |
| `path` | 27 | 0 | 0 | 0 | 0 | 27 |
| `perf` | 2 | 0 | 0 | 0 | 0 | 2 |
| `registry` | 14 | 0 | 0 | 0 | 0 | 14 |
| `scangame` | 77 | 0 | 0 | 0 | 0 | 77 |
| `scanlog` | 136 | 11 | 23 | 0 | 0 | 170 |
| `settings` | 45 | 0 | 0 | 0 | 0 | 45 |
| `shared` | 10 | 0 | 0 | 0 | 0 | 10 |
| `update` | 7 | 0 | 0 | 0 | 0 | 7 |
| `user_settings` | 0 | 5 | 29 | 153 | 0 | 187 |
