...
pub fn create_fo4_og() -> VersionInfo {
    let og_script_hashes = vec![
        ...
        (
            "Armor.pex".to_string(),
            "2bc34ab0d58f701e8684fc911742257e0768bd3e63b1eb8bdb2e043e7b67346b".to_string(),
        ),
        (
            "ArmorAddon.pex".to_string(),
            "5d9ff578b6e401526dbddedf93bdbccb4e202dba2b8b2e77809140b48fc8c1af".to_string(),
        ),
        (
            "Cell.pex".to_string(),
            "25d742d4fbe274fe5b8b3adc3775964ab9e22c1f32c47d5d3102b735c5b4e190".to_string(),
        ),
        (
            "Component.pex".to_string(),
            "80eef0f21bb7b1b9882c4a953a24aff3df8095f8464c006a96fafc0858f9b889".to_string(),
        ),
        (
            "ConstructibleObject.pex".to_string(),
            "51bdb39c81465bfbbbe509dc0a1ed40baebf4791cb35c978108e4334bcabc017".to_string(),
        ),
        (
            "DefaultObject.pex".to_string(),
            "715dff0394599587c4596488d66aab4d91311361a3ebec24a91d0ce1ddf39d77".to_string(),
        ),
        (
            "EncounterZone.pex".to_string(),
            "be0efccf70adc3a6a28f2465044d4df44cf7abe409c8624f6695d9a193eb96b6".to_string(),
        ),
        (
            "EquipSlot.pex".to_string(),
            "0e00da824263e60041086cc721896aeb304c7ec6d38fba1f548df96fda0c9ff3".to_string(),
        ),
        (
            "F4SE.pex".to_string(),
            "7d3b1be07259c9078c7f3f60cdf12041401024485750a303b0faec686a25047a".to_string(),
        ),
        (
            "FavoritesManager.pex".to_string(),
            "aed53963a5e725cea561f67525c1d50297c7a8410e6a5738b00356908d5daca7".to_string(),
        ),
        (
            "Form.pex".to_string(),
        ...
        (
            "HeadPart.pex".to_string(),
            "d25869fbf81b7d351e71cd17b6913cae01dd1b58ba76419050df6af1ed6525af".to_string(),
        ),
        (
            "Input.pex".to_string(),
            "9509a73024680963b8446b57247fdf160513a540531e87a0e2faedb610b1ffcd".to_string(),
        ),
        (
            "InstanceData.pex".to_string(),
            "57e68c4b355a94b709950ccec297b3d466f1d25e5029fed9e1423e8a12dd179f".to_string(),
        ),
        (
            "Location.pex".to_string(),
            "3538c0aaa4fe450828aee3848fe317c1654c8ed39bd811be9cff22a1e7618b49".to_string(),
        ),
        (
            "Math.pex".to_string(),
            "9bb0019795b85076837ac6845d0c79d65c9826739e59c43b97cfb949f611e822".to_string(),
        ),
        (
            "MatSwap.pex".to_string(),
            "b49d34fe1b6387d19df5140ddfbd9c340d3b10fc396e003142cdc755dc6815fc".to_string(),
        ),
        (
            "MiscObject.pex".to_string(),
            "7615656ab2867c5502507d1189cf7f938919dc585608698d2f31f782d858d23c".to_string(),
        ),
        (
            "ObjectMod.pex".to_string(),
            "d02235b5013375bf0c7785408380b3a567697879a966818df883256031b8a2b8".to_string(),
        ),
        (
        ...
        (
            "Perk.pex".to_string(),
            "04a9d0309198cbeb3a419265490be03e051d35b17b7f8ce749ffc4ea0673e16c".to_string(),
        ),
        (
            "ScriptObject.pex".to_string(),
            "a395b7fc15b193b6d8ef0184dff6293100e79ec4dd431d85e10515da46e0502c".to_string(),
        ),
        (
            "UI.pex".to_string(),
            "6b7a65b8be433bcb99dbe07d4ca9e9de2fa94140d402247b877351c2b34a36d5".to_string(),
        ),
        (
            "Utility.pex".to_string(),
            "e10d65904d0a1e9ee568bdaba02636f0183bfa9565b4056758b1461540f9be75".to_string(),
        ),
        (
            "WaterType.pex".to_string(),
            "c4f8589ed33f72265e95a6bec2c9cab58667795e972bcf5f7d17c40deed43207".to_string(),
        ),
        (
            "Weapon.pex".to_string(),
            "f39cf899d90d47d694873ccaa2a72308c6717f5e36a302d6f95243e53672d77d".to_string(),
        ),
    ];
    VersionInfo {
        id: "FO4_OG".to_string(),
...
pub fn create_fo4_ng() -> VersionInfo {
    let ng_script_hashes = vec![
        ...
        (
            "Armor.pex".to_string(),
            "ddc0e2f1b84351932cd357d4917e50faa3e262e93e4d153ec3f88a819f6711ec".to_string(),
        ),
        (
            "ArmorAddon.pex".to_string(),
            "d46a9c0c567dfbabedb2db87f29b4647ea4eca7e3a0056ab75378f2b8966ce2c".to_string(),
        ),
        (
            "Cell.pex".to_string(),
            "d472ead545a6798143db57c42f11a88754cb34bcf99ea92bb6bf3388b24dac15".to_string(),
        ),
        (
            "Component.pex".to_string(),
            "a66d315f4161747d6edc0edb7f837f937cb7eb7d5a3414777914e7b9273ba777".to_string(),
        ),
        (
            "ConstructibleObject.pex".to_string(),
            "385950805c323fa8e20beca8a940f0806169ca5cc1d173360da66a252caea384".to_string(),
        ),
        (
            "DefaultObject.pex".to_string(),
            "cd249af625d426878215682f76d870d0fe1ec4a5191a9f973187d11d700dc9b7".to_string(),
        ),
        (
            "EncounterZone.pex".to_string(),
            "bcb823d3cc4c530fcc89650a116eedfea94e69383614fe61f2daf919d5fb885b".to_string(),
        ),
        (
            "EquipSlot.pex".to_string(),
            "6188c879cc982d1e9bb2d92ebc02c32545246fd0cfd0cd892a14f9d1cdb3dee2".to_string(),
        ),
        (
            "F4SE.pex".to_string(),
            "036da39002284853551bfc38dcb36c4f20ecafaf7c0e6200a18f3bc2d68841f2".to_string(),
        ),
        (
            "FavoritesManager.pex".to_string(),
            "435469503cf478cb05293bc8e3fbf1945516620b52846123a55c7c89ed7a61f0".to_string(),
        ),
        (
            "Form.pex".to_string(),
        ...
        (
            "HeadPart.pex".to_string(),
            "925eefd6e57f7b349d4fb3e66388bee1f884a19e0d07d06ed0e63c55f4b79303".to_string(),
        ),
        (
            "Input.pex".to_string(),
            "03e390c9b6ab30f3c15108baeff00936cf26053c3357ec0ea6811e5bd6014fd4".to_string(),
        ),
        (
            "InstanceData.pex".to_string(),
            "868ce9edda89b7ee0005311280804cda2ffa975d4f4c3a10c08298dab779e58c".to_string(),
        ),
        (
            "Location.pex".to_string(),
            "1c287c2db3e6522cbe024ed24992d3c2e0d6c5eb3a49da52163ca8793e33178a".to_string(),
        ),
        (
            "Math.pex".to_string(),
            "6e2efd94287e6571b95720e5bc944b2072849290ed52092972ad69c102617089".to_string(),
        ),
        (
            "MatSwap.pex".to_string(),
            "06858608fa2701c5c1d78c0eb21e864df84c164f66f1a82edd322c2300dccce0".to_string(),
        ),
        (
            "MiscObject.pex".to_string(),
            "6729e322508d5b06f9d56dd6f833fa048ec73bff8f0086759edf1295a8fd2c96".to_string(),
        ),
        (
            "ObjectMod.pex".to_string(),
            "816e2897c7853dd15001498a762284e3c71d53f3a5c97bce167ecd30b562574e".to_string(),
        ),
        (
            "ObjectReference.pex".to_string(),
        ...
        (
            "Perk.pex".to_string(),
            "00364ee941b24ae7be7ed02f2d037da44ecf1458ce43d104de3ade6b1e2df3c7".to_string(),
        ),
        (
            "ScriptObject.pex".to_string(),
            "d7760385d670d69627408898f5b93455e8502428709fc007cd1fda2494d945c4".to_string(),
        ),
        (
            "UI.pex".to_string(),
            "a7605779bf4a29f79a8179913fca625de0f87517026a994e68bb1565c5f279b5".to_string(),
        ),
        (
            "Utility.pex".to_string(),
            "496aaa38ee6f850907d6172b996274109431d3fb8f2f459c0ab111bbbc01fe93".to_string(),
        ),
        (
            "WaterType.pex".to_string(),
            "7a1d41e063bdd8179a72b97869d27e636469988d088420c85f5297dcb1488d7a".to_string(),
        ),
        (
            "Weapon.pex".to_string(),
            "e6eee491b5a59f285a1482eb625ffb18bc63ed398bf5f8a4babca0b7edac918c".to_string(),
        ),
    ];
    VersionInfo {
        id: "FO4_NG".to_string(),
...
pub fn create_fo4_vr() -> VersionInfo {
    let vr_script_hashes = vec![
        (
            "Actor.pex".to_string(),
            "dfd7177ad93b78e3adf91a4a18ad26a9d8e4447e3dc173269798977054b82f17".to_string(),
        ),
        (
            "ActorBase.pex".to_string(),
            "659acecc1146734cf691d6d572f4c30edbbbc3ea3efb2502fd14bb91425828c8".to_string(),
        ),
        (
            "Armor.pex".to_string(),
            "3995537c4b5925b82079291d383da4bda6a284787794e65ee33a65752741f027".to_string(),
        ),
        (
            "ArmorAddon.pex".to_string(),
            "12bca4e4eddfb487c4f945fd5d6fe762475eb4d8a26ffd90fb7d0de4ddc165c7".to_string(),
        ),
        (
            "Cell.pex".to_string(),
            "34da9be5c267f599c466b9263f459b0704d7e87ccfee41fad85e93f25e76c636".to_string(),
        ),
        (
            "Component.pex".to_string(),
            "0243f0017f7190c38f17c848755a3675fb25a861dc09ef28d1dd5490a57876ff".to_string(),
        ),
        (
            "ConstructibleObject.pex".to_string(),
            "2a4de0c3190acec6ae13ee0cd936e6eefdcd5a8fb5cef8ecb845b01d67e6924e".to_string(),
        ),
        (
            "DefaultObject.pex".to_string(),
            "e7d2e193c2a9bd7e2600993da256fae6186c8fe579d0dc7592f9e27638649177".to_string(),
        ),
        (
            "EncounterZone.pex".to_string(),
            "facb76d19c4efdcd8f5b9e0329f214db130217e3e59154cf2568c30ff65916a1".to_string(),
        ),
        (
            "EquipSlot.pex".to_string(),
            "33858e7a68826a3afdccbe55e0cba34dbdbc21c3889eda6e6bcbb8f393f5dd40".to_string(),
        ),
        (
            "F4SE.pex".to_string(),
            "8b7de39f18695b2af5bdae2e3550291af1c72a7d0bbeefd65fcfe83b8d9d94bf".to_string(),
        ),
        (
            "FavoritesManager.pex".to_string(),
            "eb616c6fd7b6e9a1874fcf8840c7dac8070d1b5cb587eaf4a5a162b7f3532c0a".to_string(),
        ),
        (
            "Form.pex".to_string(),
            "bb436785aa3a8b9b6fd4c95f85982651e92dcc24cfb0a623e2dd616815bce5d8".to_string(),
        ),
        (
            "Game.pex".to_string(),
            "e9baa2e483fbbda20ab476d0df53c6c62c1410c13f288f8dc48b2853c2df73a7".to_string(),
        ),
        (
            "HeadPart.pex".to_string(),
            "6a8a34cc933b4a3a2274d2c59e3d078df42fcf2531e0518c54f16fb764d5f0fa".to_string(),
        ),
        (
            "Input.pex".to_string(),
            "ff7a9f5819b822867f9a3a2dea4a4ebfe31b3ed1fa013d82f6b9048fc8ae5e03".to_string(),
        ),
        (
            "InstanceData.pex".to_string(),
            "933f26d7185be5df62f44c9f47c95ad743a1605454c7aa9b01e16b696729b585".to_string(),
        ),
        (
            "Location.pex".to_string(),
            "130dd8512339a26cf57780dcfc093de19e4abaed7f0d7e07a8b5707af877c05d".to_string(),
        ),
        (
            "Math.pex".to_string(),
            "1375ffebd59f5070a07cccb6381624d4b5429ccf6a23fe0b9c464a135cd57b05".to_string(),
        ),
        (
            "MatSwap.pex".to_string(),
            "fa7df6ce66abde793efb8449c0e6517beafb5c88c0813ca8b81f4ceb912857bc".to_string(),
        ),
        (
            "MiscObject.pex".to_string(),
            "cec1b89d95e7ab8526dd90a1ae6f968c08c0b3b77851cc8e46e658b3049d14c6".to_string(),
        ),
        (
            "ObjectMod.pex".to_string(),
            "1385636404a733d6332cfaadd509eda8b317a319c8e3968eabae7e958c0e1522".to_string(),
        ),
        (
            "ObjectReference.pex".to_string(),
            "5f18adbfd777c6c265a46a5081c882737a350e30f336c225d509b8101f5fbecc".to_string(),
        ),
        (
            "Perk.pex".to_string(),
            "5f306d34f10168c9307d8ec98b83b3a0a49faf6c00949d5c83c8ce88791ab5d8".to_string(),
        ),
        (
            "ScriptObject.pex".to_string(),
            "6daa54faeedfefcb0da7a76ad4ab7fa48e427d5704b7367eea88c3bebc8fba4f".to_string(),
        ),
        (
            "UI.pex".to_string(),
            "523ba72eb4d17cd148ac39aaea3e5e5a64ef8484e287583987b4522b867f8414".to_string(),
        ),
        (
            "Utility.pex".to_string(),
            "9bff49b59e18636ea84033f362b45f1962c2b3740eb36ad9e9dcae94556f3490".to_string(),
        ),
        (
            "WaterType.pex".to_string(),
            "8711f4a818c1fed8b549f9cfb0fc49186bf6875cd2c8b0146c4e3154da91028f".to_string(),
        ),
        (
            "Weapon.pex".to_string(),
            "e9a18d4f7e3aa6b67fb79dee501b221e62e4fbe10baad0b47fb087735f7fb7a9".to_string(),
        ),
    ];
    VersionInfo {
        id: "FO4_VR".to_string(),
