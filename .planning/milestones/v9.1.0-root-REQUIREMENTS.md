# Requirements Archive: v9.1.0-root Move Crates to Project Root

**Archived:** 2026-04-15
**Status:** SHIPPED
**Outcomes:** 11/11 requirements validated, 0 adjusted, 0 dropped

A fresh `.planning/REQUIREMENTS.md` will be created for the next milestone.

---

# Requirements: CLASSIC v9.1.0-root
