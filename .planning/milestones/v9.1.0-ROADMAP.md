...
- ✅ **v9.1.0-consolidation Crate Consolidation** — Phases 1-5 (shipped 2026-04-12)
...
- [x] **Phase 1: YAML -> Settings Merge** - Absorb classic-yaml-core into classic-settings-core, update all consumers and bindings
- [x] **Phase 2: Crashgen -> Config Merge** - Absorb classic-crashgen-settings-core into classic-config-core, update all consumers
- [x] **Phase 3: Constants Redistribution** - Redistribute classic-constants-core across three target crates by semantic domain (version-registry-core, settings-core, shared-core), update all consumers across the workspace
- [x] **Phase 4: Gate Validation & Documentation** - All parity gates green, workspace tests pass, documentation reflects 16-crate topology
- [x] **Phase 5: Milestone Cleanup** - Close non-blocking audit debt from the consolidation milestone (stale docs index links, stale Phase 3 verification bookkeeping, stale Node parity floor tripwire)
...
|-------|----------------|--------|-----------|
| 1. YAML -> Settings Merge | 3/3 | Complete | 2026-04-10 |
| 2. Crashgen -> Config Merge | 2/2 | Complete | 2026-04-11 |
