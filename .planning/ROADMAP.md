...
Plans:
- [ ] 09-01-PLAN.md - Extend Rust PyO3 bindings with progress callback, cancellation, order preservation
- [ ] 09-02-PLAN.md - Remove Python orchestrators, update CLI/GUI to use Rust directly
