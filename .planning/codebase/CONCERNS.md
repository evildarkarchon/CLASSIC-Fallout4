...
- Files: `ClassicLib-rs/business-logic/classic-config-core/src/yamldata.rs`, `ClassicLib-rs/business-logic/classic-scanlog-core/src/orchestrator.rs`, `ClassicLib-rs/business-logic/classic-settings-core/src/yaml_ops.rs`, `ClassicLib-rs/business-logic/classic-database-core/src/pool_sqlx.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/scanner.rs`, `classic-gui/src/app/mainwindow.cpp`
...
- Files: `ClassicLib-rs/python-bindings/classic-config-py/src/lib.rs`, `ClassicLib-rs/python-bindings/classic-scanlog-py/src/orchestrator.rs`, `ClassicLib-rs/node-bindings/classic-node/src/config.rs`, `ClassicLib-rs/node-bindings/classic-node/src/fileio.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/scanner.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/files.rs`
...
- Files: `ClassicLib-rs/node-bindings/classic-node/src/fileio.rs`, `ClassicLib-rs/business-logic/classic-file-io-core/src/core.rs`
...
- Files: `ClassicLib-rs/business-logic/classic-database-core/src/pool_sqlx.rs`
...
- Files: `ClassicLib-rs/business-logic/classic-file-io-core/src/core.rs`, `ClassicLib-rs/node-bindings/classic-node/src/fileio.rs`, `ClassicLib-rs/python-bindings/classic-file-io-py/src/lib.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/files.rs`
...
- Files: `ClassicLib-rs/business-logic/classic-update-core/src/github.rs`
...
- Files: `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/scanner.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/files.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/config.rs`, `ClassicLib-rs/cpp-bindings/classic-cpp-bridge/src/settings.rs`, `ClassicLib-rs/python-bindings/classic-config-py/src/lib.rs`
...
- Test coverage: `ClassicLib-rs/business-logic/classic-database-core/tests/integration_tests.rs` covers integration behavior, but no dedicated fault-injection layer was detected for multi-database partial failure reporting.
...
- Files: `classic-cli/CMakeLists.txt`, `classic-gui/src/CMakeLists.txt`, `classic-gui/tests/CMakeLists.txt`, `ClassicLib-rs/node-bindings/classic-node/package.json`
...
- Migration plan: Pin `bun-types` in `ClassicLib-rs/node-bindings/classic-node/package.json` to a known-good version and upgrade deliberately.
...
- Files: `ClassicLib-rs/business-logic/classic-database-core/src/pool_sqlx.rs`, `ClassicLib-rs/node-bindings/classic-node/src/fileio.rs`
...
- Files: `ClassicLib-rs/business-logic/classic-database-core/src/pool_sqlx.rs`, `ClassicLib-rs/business-logic/classic-database-core/tests/integration_tests.rs`
