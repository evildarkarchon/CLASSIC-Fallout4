...
function observe(fixture: JsonObject): JsonObject {
    ...
    if (fixture.operation === "xse") {
        ...
        return {
            result: xse == null ? null : {
                acronym: xse.acronym, fullName: xse.fullName,
                compatibleVersion: xse.compatibleVersion, loader: xse.loader, fileCount: xse.fileCount
            }, error: null
        };
    }
    ...
    try {
        ...
        return {
            result: {
                matchedId: matched.versionInfo?.id ?? null,
...
function crashgen(config: JsonObject): JsonObject {
    return {
        version: config.version, name: config.name, acronym: config.acronym,
