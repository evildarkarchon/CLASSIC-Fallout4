...
export async function observePathMessage(family: string, fixture: JsonObject): Promise<JsonObject> {
    ...
    if (family === "message-operations") {
        ...
        return {
            type: message.messageType, target: message.target, content: message.content,
    ...
    try {
        ...
        if (family === "path-operations") {
            ...
            try {
                classic.validateRequiredFiles(path, request.requiredFiles);
            } catch (failure) {
        ...
        if (family === "path-normalization") {
            ...
            return {
                joinedPath: portable(joinedPath, root), normalizedPath: portable(normalizedPath, root),
