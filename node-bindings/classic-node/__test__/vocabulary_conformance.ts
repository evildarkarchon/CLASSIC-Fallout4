...
const operations = {
    "config-vocabulary": {
        ...
        scan_run_installed_yaml_data_provenance_label: {
            resolve: classic.installedYamlDataProvenanceLabel,
            enumInput: true
        },
        installed_yaml_data_diagnostic_kind_label: {
            resolve: classic.installedYamlDataDiagnosticKindLabel,
            enumInput: true
        },
    ...
    "scan-run-vocabulary": {
        scan_run_installed_yaml_data_diagnostic_kind_label: {
            resolve: classic.scanRunInstalledYamlDataDiagnosticKindLabel,
            enumInput: true
        },
        scan_run_local_ignore_yaml_data_state_label: {
            resolve: classic.scanRunLocalIgnoreYamlDataStateLabel,
            enumInput: true
        },
        ...
        scan_run_infrastructure_error_stage_label: {
            resolve: classic.scanRunInfrastructureErrorStageLabel,
            enumInput: false
        },
        scan_run_local_ignore_reset_failure_stage_label: {
            resolve: classic.scanRunLocalIgnoreResetFailureStageLabel,
            enumInput: false
        },
    },
};
...
export function observeVocabulary(family: string, input: Record<string, unknown>): Record<string, unknown> {
    ...
    return {
        operation, entries: tokens.map((token: string) => {
