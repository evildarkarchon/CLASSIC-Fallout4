...
import { JsFileGenerator, generateIgnoreFile, generateLocalYaml } from "../index.js";
...
export async function observeFileGeneration(fixture: Record<string, any>): Promise<Record<string, any>> {
  ...
  try {
    ...
    const result: Record<string, any>={paths:[generator.ignoreFilePath().replaceAll("\\","/"),generator.localYamlPath().replaceAll("\\","/")],before:await inventory(root)};
